...
SET APP_HOME="D:\users\ianbo\Documents\Business\Bond-and-Pollard\Admin\IT\source-repository\oracle-appsdemo"
...
SET DATA_HOME=D:\users\ianbo\Documents\Business\Bond-and-Pollard\Admin\IT\source-repository\oracle-appsdemo\data
